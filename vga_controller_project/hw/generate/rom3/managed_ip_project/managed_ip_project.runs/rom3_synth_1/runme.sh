...
HD_PWD='C:/Users/hafer/Desktop/VHDL/vga_controller_project/hw/generate/rom3/managed_ip_project/managed_ip_project.runs/rom3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom3.vds -m64 -mode batch -messageDb vivado.pb -notrace -source rom3.tcl
