...
HD_PWD='C:/Users/hafer/Desktop/VHDL/vga_controller_project/hw/impl/vga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_controller_top_struc_cfg.vds -m64 -mode batch -messageDb vivado.pb -notrace -source vga_controller_top_struc_cfg.tcl
