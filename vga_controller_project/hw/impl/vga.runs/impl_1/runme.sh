...
HD_PWD='C:/Users/hafer/Desktop/VHDL/vga_controller_project/hw/impl/vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_controller_top_struc_cfg.vdi -applog -m64 -messageDb vivado.pb -mode batch -source vga_controller_top_struc_cfg.tcl -notrace
