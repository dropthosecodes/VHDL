...
HD_PWD='C:/Users/hafer/Desktop/VHDL/mc8051_basys3/hw/impl/mc8051.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_top_rtl_cfg.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fpga_top_rtl_cfg.tcl
