...
HD_PWD='C:/Users/hafer/Desktop/VHDL/mc8051_basys3/hw/impl/mc8051.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_top_rtl_cfg.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fpga_top_rtl_cfg.tcl -notrace
